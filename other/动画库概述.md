...
1. Star：22985，min.js：14.1KB，11月前（201808）
...
1. Star：14347， min.js：多版本（最小的11KB），2天前（201808）
2. 主要特点
...
1. star：15051，min.js：47KB，1月前（201808）
2. 兼容性：IE8
3. 是jQuery.animate()动画的加速版本，因此可以将jQuery.animate()完全，替换为$.velocity()
...
1. Star：10671，min.js：11.7KB，3月前（201808）
2. 无依赖的使svg形成动画的库
...
1. star：16540，min.js:22.8KB，3年前（201808）
2. 官网演示挂了，只有api介绍，没有使用demo
...
1. Star：53802，min.css：56.6KB，1个月前（201808）
...
1. star：7213，min.js：14kB，2月前（201808）
2. css3驱动的动画库
3. 主要功能：向上或向下滚动鼠标时，对某些元素进行动画处理，当返回top时，元素回到原始状态

## scrollreveal

### 主要是滚动动画操作（商业许可）

1. star:16152，min.js：16KB，22天前（201808）
2. 兼容性：ie8+，**商业不许可**
3. 除了主页demo并没有其他demo，**感觉就是向下滚动，逐渐显示元素的一个库**
